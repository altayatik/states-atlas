...
export const metroAreas = [
  ...
  },
  {
    ...
    stateCodes: ['AK'],
    status: 'visited',
    geometry: { type: 'Point', coordinates: [-135.33, 57.0531] },
  },
  {
    id: 'ketchikan',
    name: 'Ketchikan',
    stateCodes: ['AK'],
    status: 'visited',
    geometry: { type: 'Point', coordinates: [-131.6461, 55.3422] },
  },
  {
    id: 'honolulu',
    name: 'Honolulu',
  ...
  },
  {
    ...
    stateCodes: ['HI'],
    status: 'visited',
    geometry: { type: 'Point', coordinates: [-155.09, 19.7072] },
  },
  {
    id: 'kailua-kona',
    name: 'Kailua-Kona',
    stateCodes: ['HI'],
    status: 'visited',
    geometry: { type: 'Point', coordinates: [-155.9969, 19.6399] },
  },
  {
    id: 'lahaina',
    name: 'Lahaina',
    stateCodes: ['HI'],
    status: 'visited',
    geometry: { type: 'Point', coordinates: [-156.6825, 20.8783] },
  },
  {
    id: 'kahului',
    name: 'Kahului',
    stateCodes: ['HI'],
    status: 'visited',
    geometry: { type: 'Point', coordinates: [-156.47, 20.8893] },
  },
  {
    id: 'toronto',
    name: 'Toronto',
